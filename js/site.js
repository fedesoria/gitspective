...
(function() {
  var Event, Repo, TimeStamps, User, hasMorePages, parseISODate, _ref, _ref1,
  ...
  Repo = (function(_super) {
    ...
    function Repo() {
      _ref1 = Repo.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  Event = (function(_super) {
    ...
    Event.consolidateEvents = function(events) {
      var e, groups, keptEvent, otherEvents, pushEvents, _, _i, _j, _k, _len, _len1, _len2, _name, _ref2, _ref3, _ref4;
      _ref2 = [[], []], otherEvents = _ref2[0], pushEvents = _ref2[1];
      ...
      for (_ in groups) {
        ...
        keptEvent.addCommits((_ref3 = keptEvent.payload) != null ? _ref3.commits : void 0);
        for (_k = 0, _len2 = events.length; _k < _len2; _k++) {
          e = events[_k];
          keptEvent.addCommits((_ref4 = e.payload) != null ? _ref4.commits : void 0);
        }
      ...
      view = (function() {
        ...
        switch (this.type) {
          ...
          case "CreateEvent":
            ...
            break;
          case "PushEvent":
            if (((_ref2 = this.payload.commits) != null ? _ref2.length : void 0) > 0) {
              return "push";
            }
            break;
          case "GollumEvent":
            if (((_ref3 = this.payload.pages) != null ? _ref3.length : void 0) > 0) {
              return "gollum";
            }
            break;
          default:
  ...
  window.App = (function(_super) {
    ...
    App.prototype.appendEvents = function(events) {
      var _this = this;
      events.forEach(function(event) {
        var html, viewArgs, viewType, _ref2;
        _ref2 = event.viewInfo(), viewType = _ref2[0], viewArgs = _ref2[1];
        if (viewType) {
